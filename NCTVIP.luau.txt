...
local v466 = loadstring(game:HttpGet("https://pastefy.app/cgRXe9Xh/raw"))():MakeWindow({
    Title = "NCT Hub",
    SubTitle = "by NCT On TOP",
    SaveFolder = "Redz | redz lib v5.lua"
})
local l_ScreenGui_0 = Instance.new("ScreenGui")
l_ScreenGui_0.Name = "ControlGUI"
l_ScreenGui_0.Parent = game.CoreGui
local Button_0 = Instance.new("eeButton")
l_ImageButton_0.Size = UDim2.new(0, 50, 0, 50)
l_ImageButton_0.Position = UDim2.new(0.15, 0, 0.15, 0)
l_ImageButton_0.Image = "rbxassetid:// 122126282862563"
...
local v484 = v466:MakeTab({"Th\195\180ng Tin | Info","rbxassetid://122126282862563"})
local v485 = v466:MakeTab({"Farming","rbxassetid://122126282862563"})
local v486 = v466:MakeTab({"Auto Fishing","rbxassetid://122126282862563"})
local v487 = v466:MakeTab({"Quest | Items","rbxassetid://122126282862563"})
local v488 = v466:MakeTab({"Volcano Dojo","rbxassetid://122126282862563"})
local v489 = v466:MakeTab({"Sea Event","rbxassetid://122126282862563"})
local v490 = v466:MakeTab({"Race V4","rbxassetid://122126282862563"})
local v491 = v466:MakeTab({"Raid Fruits","rbxassetid://122126282862563"})
local v492 = v466:MakeTab({"Fruits | Check Stock","rbxassetid://"122126282862563})
local v493 = v466:MakeTab({"Teleport","rbxassetid://122126282862563"})
local v494 = v466:MakeTab({"PvP,Player","rbxassetid://122126282862563"})
local v495 = v466:MakeTab({"Shop","rbxassetid://122126282862563"})
local v496 = v466:MakeTab({"Settings","rbxassetid://122126282862563"})
v484:AddDiscordInvite({
    Name = "Tham Gia Discord",
    Description = "Link Sever Discord",
    logo = "rbxassetid://122126282862563",
    Invite = "https://www.tiktok.com/@ngcongthanh06?_r=1&_t=ZS-93A7EExc3Y0"
})
v484:AddDiscordInvite({
    Name = "NCT Hub",
